...
reasoning_agent = AutoTokenizer.from_pretrained(model_id, use_fast = True)
...
inputs = reasoning_agent.apply_chat_template(messages, tokenize=True, add_generation_prompt=True, return_dict = True, return_tensors = 'pt').to(model.device)
